export function PlusIcon({ className = 'w-[22px] h-[22px]' }) {
  return (
...
export function MicIcon({ className = 'w-7 h-7' }) {
  return (
...
/**
 * Send. Replaces a literal '↵' character, which rendered at whatever the
 * button's font-size happened to be — tiny, and at the mercy of the font.
 */
...
/* --- The four navigation icons ------------------------------------------
   These lived inside BottomNav.jsx until the desktop sidebar arrived and
   needed the same four. Moved here rather than exported from BottomNav,
   because a module that exports components may export nothing else without
   react-refresh complaining — and the tab list itself is data, not a
   component, so it went to navTabs.js. */

export function InboxIcon({ className = 'w-[22px] h-[22px]' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function TodayIcon({ className = 'w-[22px] h-[22px]' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function CalendarIcon({ className = 'w-[22px] h-[22px]' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
      <line x1="16" y1="2" x2="16" y2="6" />
...
export function BrowseIcon({ className = 'w-[22px] h-[22px]' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
